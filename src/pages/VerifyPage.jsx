...
export default function VerifyPage(props) {
		...
		if(props.location.mobile){
				...
				if(verifyData.mobile == undefined || verifyData.mobile == null || verifyData.mobile == "undefined" || verifyData.mobile == "" || verifyData.mobile == "null")
		...
		const handleSubmit = () => {
				...
				Axios.post(`${BASE_URL}/verify/`, {mobile_number: verifyData.mobile, otp: verifyData.otp}).then(
						response => {
